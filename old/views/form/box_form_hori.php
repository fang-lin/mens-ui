<div class="m-box">
    <div class="m-box-header">
        <h1 class="m-box-h1">class="m-form-hori"</h1>
        ...
        <div class="m-box-in-body">
            <form action="">
                <ul class="m-form hori-form">
                    <li class="m-form-hori">
                        <label class="m-form-lb">Label A</label>
                        <div class="m-form-in">
                            <input type="text" name="" class="m-input"/>
                        </div>
                        <span class="m-form-ntc">
                    ...
                    <li class="m-form-hori">
                        ...
                        <div class="m-form-in">
                            <div class="m-select" name="test-select-h">
                                <input type="text"/>
                                <span class=""></span>
                            </div>
                            <ul class="m-options" id="test-select-h">
                        ...
                        <span class="m-form-ntc">Notice B</span>
                    </li>
                    <li class="m-form-hori">
                    ...
                    <li class="m-form-hori">
                        ...
                        <div class="m-form-in">
                            <input type="button" class="m-button" value="Submit"/>
                        </div>
                        <span class="m-form-ntc">Notice</span>
                    </li>
                </ul>
            </form>
        </div>
